...
// ============================================================================
// CHAT / MESSAGING IS DISABLED
// ----------------------------------------------------------------------------
// The whole messaging feature is commented out for now. This page only exists
// so that any old link to /messages does not 404 - it just sends the user to
// their inbox (alerts). To bring chat back:
//   1. Restore the implementation commented out at the bottom of this file.
//   2. Re-enable the entry points marked "CHAT DISABLED" in:
//        - components/Navbar.tsx
//        - components/RouteGuard.tsx
//        - app/inbox/page.tsx           (Messages tab)
//        - app/brands/[id]/page.tsx     (Message / Enquiry buttons)
//        - app/creators/[id]/page.tsx   (Message / Enquiry buttons)
//        - components/HowItWorks.tsx    ("Instant Chat" step)
//   3. Re-mount `app.use('/api/messages', messageRoutes)` in server/index.js.
// ============================================================================
...
// ----------------------------------------------------------------------------
// Original implementation (kept for when chat is re-enabled)
// ----------------------------------------------------------------------------
// 'use client';
// 
...
//                         {/* Conversations List */}
//                         <div className={`bg-white/[0.02] backdrop-blur-xl border border-white/[0.05] rounded-2xl overflow-hidden ${selectedConversation ? 'hidden md:block' : 'block'}`}>
...
// 
//                         {/* Chat View */}
//                         <div className={`md:col-span-2 bg-white/[0.02] backdrop-blur-xl border border-white/[0.05] rounded-2xl overflow-hidden flex-col ${selectedConversation ? 'flex' : 'hidden md:flex'}`}>
