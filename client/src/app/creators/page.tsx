        ...
        const fetchInitialData = async () => {
            ...
            try {
                ...
                const [bandsRes, brandsRes, orgRes, trendingRes, topRes] = await Promise.all([
                    brandsApi.getAll({ type: 'Band' }) as Promise<BrandsResponse>,
                    brandsApi.getAll({ type: 'Brand' }) as Promise<BrandsResponse>,
                    brandsApi.getAll({ type: 'Organizer' }) as Promise<BrandsResponse>,
                    brandsApi.getAll({ sort: 'trending' }) as Promise<BrandsResponse>,
                    brandsApi.getAll({ sort: 'top' }) as Promise<BrandsResponse>,
                ]);
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    {!isLoading && !isFiltered && (
                        <>
                            ...
                            {/* CTA Section - Only show for non-creators */}
                            {!isCreator && (
                                <FadeIn>
