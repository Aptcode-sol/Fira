...
interface ReadyToGoSectionProps {
    cityFilter?: string;
}

export default function ReadyToGoSection({ cityFilter }: ReadyToGoSectionProps) {
    ...
    const fetchEvents = useCallback(async () => {
        setIsLoading(true);
        try {
            const params: Record<string, string> = { dateFilter: 'today', limit: '10' };
