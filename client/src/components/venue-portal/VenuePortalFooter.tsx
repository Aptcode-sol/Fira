...
const footerLinks = {
    portal: [
        { label: 'Dashboard', href: '/venue-portal/dashboard' },
        { label: 'My Venues', href: '/venue-portal/venues' },
        { label: 'Bookings', href: '/venue-portal/bookings' },
...
export default function VenuePortalFooter() {
        ...
        >
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                    ...
                    >
                        <Link href="/venue-portal/landing" className="flex items-center space-x-2 mb-4 group">
                            <motion.div
                    ...
                    <motion.div variants={itemVariants}>
                        <h4 className="text-white text-sm font-medium mb-4">Venue Portal</h4>
                ...
                >
                    ...
                    >
                        © {new Date().getFullYear()} FIRA Venue Portal. All rights reserved.
                    </motion.p>
                    <motion.p
