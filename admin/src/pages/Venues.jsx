        ...
        <div className="p-6 lg:p-8">
            <FadeIn>
                ...
                <div className="bg-white/[0.02] backdrop-blur-sm border border-white/[0.08] rounded-2xl overflow-hidden">
                    {loading ? (
                        <div className="p-12 text-center text-gray-300">Loading venues...</div>
                    ) : (
                            ...
                            <table className="w-full text-left">
                                <thead className="bg-white/[0.02] border-b border-white/[0.05]">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 text-xs font-semibold text-gray-300 uppercase tracking-wider">Capacity</th>
                                        <th className="px-6 py-4 text-xs font-semibold text-gray-300 uppercase tracking-wider">Status</th>
                                        <th className="px-6 py-4 text-xs font-semibold text-gray-300 uppercase tracking-wider">Created</th>
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-gray-300 text-xs">{venue.owner?.email}</span>
                                                </div>
                                            </td>
                                            ...
                                            <td className="px-6 py-4 text-gray-300 text-sm">{new Date(venue.createdAt).toLocaleDateString()}</td>
